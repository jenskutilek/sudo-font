...
\title{The Sudo Font Family\\ For Coding and User Interfaces\\ Version 4.0-beta1}
\author{Jens Kutílek}
...
\input{opentype-features.tex}


\section{DIN 91379 Character Set}
\input{din91379-blocks.tex}
...
According to Hyperglot 0.8.1, Sudo v3.5+ supports 493 Latin, Cyrillic, and Greek languages:
...
Copyright 2009, 2026 The Sudo Font Project Authors (https://github.com/jenskutilek/sudo-font.git)
